      ...
      <div className="container">
        <div className="nasa-planets">
          <div className="nasa-planet">
            <img
              src="https://image.freepik.com/free-photo/structure-core-earth-structure-layers-earth-structure-earth-s-crust-earth-cross-section-space-view-elements-this-image-furnished-by-nasa-3d-rendering_92790-451.jpg"
              alt="over"
            />
          </div>
          <div className="nasa-planet">
            <img
              src="https://upload.wikimedia.org/wikipedia/commons/1/1b/Earth_Aurora_%28Auroral_X-ray_emission_observed_from_Earth%27s_north_polar_region.%29_%282940640045%29.jpg"
              alt="over"
            />
          </div>
          <div className="nasa-planet">
            <img
              src="https://qph.fs.quoracdn.net/main-qimg-937bb10c8550c2fa8564031ec8e9e6f4"
              alt="over"
            />
          </div>
        </div>

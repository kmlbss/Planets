      ...
      <div className="container">
        <div className="nasa-planets">
          <div className="nasa-planet">
            <img
              src="https://upload.wikimedia.org/wikipedia/commons/f/fe/Uranus-intern-en.png"
              alt="over"
            />
          </div>
          <div className="nasa-planet">
          ...
          <div className="nasa-planet">
            <img
              src="https://cdn.britannica.com/08/18808-138-05FFA950/Voyager-2-space-probe-Uranus-computer-animation-Jan-24-1986.jpg"
              alt="over"
            />
          </div>
        </div>

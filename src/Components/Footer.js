        ...
        <div className="footer-clm" data-aos="fade-up">
          ...
          <div className="footer-content">
            <p>
              ...
              yerləşir.15-ci əsrədək 7 planet olduğu fərz edilirdi. Hesab olunurdu ki, onlar
              Yer ətrafında fırlanır. XVI əsrdə Nikolay Kopernik Dünyanın
              heliosentrik sistemini yaratdı və sübut etdi ki, bütün planetlər
              Günəş ətrafında, Ay isə digər planetlərin peykləri kimi Yerin
              ətrafında fırlanır.
            </p>
          </div>
          </div>
